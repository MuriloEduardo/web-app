...
export default async function ConversaPage({ params }: PageProps) {
    ...
    return (
        <main className="mx-auto flex min-h-screen w-full max-w-5xl flex-col gap-6 px-6 py-10 dark:bg-gray-900">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-[280px_1fr]">
                ...
                <div className="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-black">
                    <div className="flex flex-col gap-2 overflow-y-auto pb-4 max-h-[70vh]">
                        {messages.map((m) => {
